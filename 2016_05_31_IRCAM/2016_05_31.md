...
- Many playing techniques that are traditionally represented with black-ink symbols or verbal descriptions, are instead merged into a single region
- Many of them able to morph into another dynamically
...
^
At this point, I am considering how to move forward with this
...
- Convert primitive string tablature information into staff information, and back
- Convert woodwind fingering (to start with, flutes) information into staff information, and back
...
- But many "materials" can be notated in either style, and be more effective at different points in the learning, rehearsing, and performing process of the performer

^
It became clear that some things were more effectively notated in certain ways.
More importantly, is that relationship shifts over the process of learning, rehearsing, and performing a piece.
